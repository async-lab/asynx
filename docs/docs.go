...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/users": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "单个注册请求 (Content-Type: application/json)",
                        "name": "body",
                        "in": "body",
                        "schema": {
                    ...
                    {
                        "type": "file",
                        "description": "批量注册CSV文件 (Content-Type: multipart/form-data)",
                        "name": "file",
                        "in": "formData"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "批量注册全部成功",
                        "schema": {
                            "type": "object",
                            "properties": {
                                "data": {
                                    "$ref": "#/definitions/controller.BatchRegisterResult"
                                }
                            }
                        }
                    },
                    "207": {
                        "description": "批量注册部分失败",
                        "schema": {
                            "type": "object",
                            "properties": {
                                "data": {
        ...
        "/users/category": {
            "patch": {
                ...
                "parameters": [
                    {
                        "description": "批量修改账号类型请求",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controller.RequestBatchModifyCategory"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "全部成功：批量修改结果",
                        "schema": {
                            "type": "object",
                            "properties": {
                                "data": {
                                    "$ref": "#/definitions/controller.BatchModifyResult"
                                }
                            }
                        }
                    },
                    "207": {
                        "description": "部分失败：批量修改结果",
                        "schema": {
                            "type": "object",
                            "properties": {
                                "data": {
        ...
        "/users/role": {
            "patch": {
                ...
                "parameters": [
                    {
                        "description": "批量修改角色权限请求",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controller.RequestBatchModifyRole"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "controller.BatchModifyResult": {
            ...
            "properties": {
                ...
                "failures": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/controller.BatchModifyFailure"
                    }
                },
                "success": {
                    "type": "integer"
        ...
        "controller.BatchRegisterResult": {
            "type": "object",
            "properties": {
                "failed": {
                    "type": "integer"
                ...
                "failures": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/controller.BatchFailureInfo"
                    }
                },
                "success": {
                    "type": "integer"
        ...
        "controller.RequestBatchModifyCategory": {
            "type": "object",
            "required": [
                "category",
                "userIds"
        ...
        "controller.RequestBatchModifyRole": {
            "type": "object",
            "required": [
                "role",
                "userIds"
